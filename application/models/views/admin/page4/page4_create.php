    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('Admin/page4_store', 'role="form" id="fromvalid"'); ?>
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Add সামাজিক কর্মকাণ্ডের চিত্র</button>
