        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="card-title">চুড়ান্ত ফলাফল তালিকা</h3>
                        </div>
                        <!-- <div class="col-4">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <form action="<?php echo base_url(); ?>Admin/joining_letter_create" method="post">
                                                            <input type="hidden" name="candidate_id" value="<?php echo $value->aev_r_candidate_id; ?>">
                                                            <input type="hidden" name="aev_designation" value="<?php echo $value->aev_designation; ?>">
                                                            <input type="hidden" name="aev_id" value="<?php echo $value->aev_id; ?>">
                                                            <input type="hidden" name="aev_rec_id" value="<?php echo $value->aev_rec_id; ?>">
                                                            <button type="submit" class="custom_btn bg-olive"><i class="fas fa-dollar-sign"></i></button>
                                                        </form>
                                                    </div>
                                                    <div class="col-6">
