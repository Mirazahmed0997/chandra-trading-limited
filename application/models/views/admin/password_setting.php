        ...
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <?php
                    ...
                    if ($newpass!=$conpass) redirect("Admin/password_setting?sk=3");
                    $id=$this->session->userdata('currentActiveId');
                    $this->db->where('a_id',$id);
                    $this->db->update('authority',array('a_key'=>md5($newpass)));
                    redirect("Admin/password_setting?sk=1");
                    }
                    ?>
                    <div id="page-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                                <?php echo form_open('Admin/password_setting','role="form" id="fromvalid"');?>
                                                <div class="row">
                                                    <div class="col-lg-12">
