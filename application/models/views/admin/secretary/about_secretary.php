        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10">
                            <h3 class="card-title">সম্পাদক</h3>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open_multipart('Admin/about_secretary_update', 'role="form" id="fromvalid"'); ?>
                    <input type="hidden" name="id" value="<?php if(!empty($about_secretary)){ echo $about_secretary->id; } ?>">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label id="title">সম্পাদক Name*</label>
                                        <input type="text" name="title" id="title" class="form-control input-sm" value="<?php if(!empty($about_secretary)){ echo $about_secretary->name; }?>" data-bv-notempty="true">
                                    </div>
                                    <div class="form-group">
                                        <label id="title">সম্পাদক Description*</label>
                                        <textarea name="pageditor" class="form-control" id="pageditor"><?php if(!empty($about_secretary)){ echo $about_secretary->about; } ?></textarea>
                                    </div>
                                    <!--<div class="form-group">
