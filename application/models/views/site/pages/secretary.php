    ...
    <div class="col-md-12 col-lg-12" style="">
        ...
        <div id="posts" class="small-thumbs alt">
            <div class="text-center">
                <h3 style="background-color:#25A454;color: white;margin:5px; padding:8px;">সহ-সভাপতিগণের তালিকা</h3>
            </div>
            <div class="entry nobottomborder" style=" margin-top:15px;">
                <table class="table table-bordered">
                    <thead>
                    <tr>
                   <th>কমিটির অবস্থান </th>
                   
                        <th>নাম</th>
                        <th>ছবি</th>
                        <th>ব্যবস্থাপনা কমিটির ধরণ</th>
                        <th>কার্যকাল</th>
                    ...
                    <?php if(!empty($vice_principle)): ?>
                        <?php foreach($vice_principle as $k => $r):?>
                             <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>Site/about_vice_president/<?php echo $r->id; ?>"><?php echo $r->title; ?></a></td>
                                <td class="center">
