      ...
      <div class="row">
        <div class="col-md-6 content" data-aos="fade-right">
          <div class="box">
            ...
            <hr>
            <a href="<?php echo base_url('Recruitment/welcome'); ?>" class="btn btn-info">Read More</a>
          </div>
        ...
        <div class="col-md-6 d-md-block" data-aos="fade-left">	
          <div class="box">
            ...
            <hr>
            <a href="<?php echo base_url('Recruitment/job_openings'); ?>" class="btn btn-info">Read More</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6 content" data-aos="fade-right">
          <div class="box">
            ...
            <hr>
            <a href="<?php echo base_url('Recruitment/registration'); ?>" class="btn btn-info">Read More</a>
          </div>
        ...
        <div class="col-md-6 d-md-block" data-aos="fade-left">
          <div class="box">
            ...
            <hr>
            <a href="<?php echo base_url('Recruitment/login'); ?>" class="btn btn-info">Read More</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6 content" data-aos="fade-right">
          <div class="box">
            ...
            <hr>
            <a href="<?php echo base_url('Recruitment/how_to_apply'); ?>" class="btn btn-info">Read More</a>
          </div>
        ...
        <div class="col-md-6 d-md-block" data-aos="fade-left">
          <div class="box">
            ...
            <hr>
            <a href="<?php echo base_url('Recruitment/faq'); ?>" class="btn btn-info">Read More</a>
          </div>
        </div>
      </div>
    </div>
