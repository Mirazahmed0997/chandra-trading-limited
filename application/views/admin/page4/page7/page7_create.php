    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('Admin/page7_store', 'role="form" id="fromvalid"'); ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="name" value="<?php echo set_value("name"); ?>" class="form-control" id="textAreaExample1" rows="4"></textarea>
