                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-hover mt-2 table-striped print-table"
                                            ...
                                            <thead class="table-head">
                                                <tr>
                                                    <th class="text-center text-bold align-center" rowspan="2">নং
                                                    </th>
                                                    <th class="text-center text-bold align-center" rowspan="2">সমিতির
                                                        নাম</th>
                                                    <th class="text-center text-bold align-center" colspan="3">বিতরণ
                                                        সংখ্যা
                                                    </th>
                                                    <th class="text-center text-bold align-center" colspan="3">বিতরণ
                                                        টাকা
                                                    ...
                                                    <th class="text-center text-bold align-center" colspan="7"
                                                        style="white-space: nowrap;">ধরণ সংখ্যা</th>
                                                ...
                                                <tr>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">মাসের বিতরণ</th>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">পূর্বের বিতরণ</th>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">মোট বিতরণ</th>
                                                    ...
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">ফার্নিচার</th>
                                                    <th class="text-center text-bold align-top"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">শিক্ষিত বেকার কেন্দ্রীয় সঞ্চয় ও ঋণদান সমবায় সমিতি লিঃ</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>

                                                    <td class="text-center align-middle" style="white-space: nowrap;">25
                                                    </td>

                                                    <td class="text-center align-middle" style="white-space: nowrap;">40
                                                    </td>

                                                    <td class="text-right align-middle truncated">
                                                        <span class="truncated-text"><abbr
                                                                title="লাকসাম, কুমিল্লা">10000</abbr></span>
                                                    </td>

                                                    <td class="text-right align-middle">80000</td>
                                                    ...
                                                    <td class="text-center align-middle" style="white-space: nowrap;">5
                                                    </td>



                                                    <td class="text-center align-middle view"><i class="fas fa-eye"></i>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">ওয়্যারলেছ বাজার শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">চাঁদপুর শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">মহামায়া শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">হাজীগঞ্জ শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">পাটওয়ারী বাজার শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">বাঘড়া শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">টোরা মুন্সির হাট শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">রূপসা শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">ফরিদগঞ্জ শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">নয়া হাট শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">কচুয়া শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">মতলব শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">শাহরাস্তি শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি..</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">গৃদকালিন্দিয়া শিক্ষিত বেকার সঞ্চয় ও ঋণদান সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2</td>
                                                    <td class="align-middle truncated">
                                                        <span class="truncated-text"><abbr title="শিক্ষিত বেকার">চান্দ্রা শিক্ষিত বেকার যুব বহুমূখী সমবায় সমিতি লি.</abbr></span>
                                                    </td>
                                                    <td class="align-right text-center">15</td>
                                                ...
                                                <tr>
                                                    <td class="text-right text-bold align-middle" colspan="2">মোট=
                                                    </td>
                                                    <td class="text-center align-middle">02</td>
                                                    <td class="text-center align-middle">100000</td>
                                                    <td class="text-center align-middle">0</td>
                                                    <td class="text-right align-middle">100000</td>
                                                    <td class="text-right align-middle">100000</td>
                                                    <td class="text-right align-middle">100000</td>
                                                    <td class="text-center align-middle">5</td>
                                                    <td class="text-center align-middle">5</td>
