                            ...
                            <div class="title-section d-flex justify-content-center my-3">
                                ...
                                <div class="border border-dark p-2 text-center w-auto table-name "
                                    ...
                                    <h3 class="m-0 text-dark font-weight-bold" style="font-size: 16px;">
                                        দৈনিক কিস্তির সংখ্যা তালিকা (সম্মিলিত)
                                    </h3>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-hover mt-2 table-striped print-table"
                                            ...
                                            <thead class="table-head">
                                                <tr>
                                                    <th class="text-center text-bold align-top" rowspan="2">তারিখ
                                                    </th>
                                                    <th class="text-center text-bold align-top" rowspan="2">সমিতির
                                                        নাম</th>
                                                    <th class="text-center text-bold align-top" colspan="4">দিনের
                                                        বিনিয়োগ সংখ্যা
                                                    </th>


                                                    <th class="text-center text-bold align-top" rowspan="2"
                                                        style="white-space: nowrap;">কিস্তির টাকার <br> পরিমাণ</th>
                                                    <th class="text-center text-bold align-top" rowspan="2"
                                                        style="white-space: nowrap;">বিনিয়োগ <br> অফিসার সংখ্যা</th>
                                                    <th class="text-center text-bold align-top " rowspan="2"
                                                ...
                                                <tr>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">হালনাগাদ</th>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">ভিউ</th>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">খেলাপি ও বকেয়া</th>
                                                    <th class="text-center text-bold align-top"
                                                        style="white-space: nowrap;">ভিউ</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">2026-05-18</td>
                                                    <td class="align-middle truncated">

                                                    </td>
                                                    <td class="align-right text-center"></td>

                                                    <td class="text-center align-middle" style="white-space: nowrap;"><i
                                                            class="fas fa-eye"></i>
                                                    </td>
                                                    ...
                                                    <td class="text-center align-middle "><i class="fas fa-eye"></i>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center align-middle">2026-05-18</td>
