        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="<?= base_url('update_properties_form/' . $property->id); ?>" class="btn btn-primary">
                        ...
                        <div class="col-12">
                            <div class="card border-0 shadow-sm overflow-hidden">
                                <div class="ratio ratio-21x9">
                                    <iframe src="<?= html_escape($property->map_location); ?>" width="820" height="450"
                            ...
                            <?php if (!empty($gallery) && is_array($gallery)): ?>
                                <div class="row g-2">
                                    <?php foreach ($gallery as $img): ?>
                                        <div class="col-4">
                                            <a href="<?= base_url('./assets/uploads/properties/images/' . $img); ?>"
                                                target="_blank">
                                                <img src="<?= base_url('./assets/uploads/properties/images/' . $img); ?>"
                                                    class="img-fluid rounded border"
                                                    style="height: 80px; width: 100%; object-fit: cover;" alt="Gallery Image">
                                            </a>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <?php if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'webp', 'gif'])): ?>
                                    <a href="<?= base_url('./assets/uploads/properties/floor_plan/' . $property->floor_plan); ?>"
                                        ...
                                        <img src="<?= base_url('./assets/uploads/properties/floor_plan/' . $property->floor_plan); ?>"
                                            ...
                                            style="max-height: 200px; object-fit: contain;" alt="Floor Plan">
                                    </a>
                                <?php else: ?>
                                    <a href="<?= base_url('./assets/uploads/properties/floor_plan/' . $property->floor_plan); ?>"
                        ...
                        <?php if (!empty($property->brochure)): ?>
                            ...
                            <?php if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'webp', 'gif'])): ?>
                                <a href="<?= base_url('./assets/uploads/properties/brochure/' . $property->brochure); ?>"
                                    target="_blank">
                                    <img src="<?= base_url('./assets/uploads/properties/brochure/' . $property->brochure); ?>"
                                        class="img-fluid rounded border w-100" style="max-height: 200px; object-fit: contain;"
                                        alt="Floor Plan">
                                </a>
                            <?php else: ?>
                                <a href="<?= base_url('./assets/uploads/properties/brochure/' . $property->brochure); ?>"
