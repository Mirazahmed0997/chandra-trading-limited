<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <!-- Search / Filter Form -->
            <form method="get" action="<?= base_url('home_Page_managment_controller/achievements_list') ?>">
        ...
        <div class="container-fluid">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0 text-center">সাফল্য তালিকা</h5>
                </div>
                    ...
                    <div class="table-responsive" style="overflow:auto;">
                        <table id="membersTable" class="table table-bordered table-striped table-hover"
                            ...
                            <button type="button" class="btn btn-success m-2" id="openCreateModal">
                                <i class="fas fa-edit"></i> Create new achievement
                            </button>
                            ...
                            <tbody>
                                ...
                                foreach ($achievements as $row): ?>
                                    <tr>
                                        ...
                                        <td><?= $row->details; ?></td>
                                        <td>
                                            <form action="<?= base_url('achievement_active_status/' . $row->id); ?>"
                                                method="post">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('delete_achievement/' . $row->id) ?>"
                                                class="btn btn-danger btn-sm"
                                                onclick="return confirm('Are you sure you want to delete this info?')"><i
...
<?php $this->load->view('admin/achievements/achievement_create_form'); ?>

<!-- ---------------------update popup-------------------------- -->

<?php $this->load->view('admin/achievements/achievements_update_form'); ?>
...
<script>
    ...
    $(document).ready(function () {
        $('.open-charge-modal').on('click', function () {
            ...
            if ($('#chargeModal input[name="achievement_id"]').length === 0) {
                $('<input>').attr({
                    type: 'hidden',
                    name: 'achievement_id',
                    value: id
                ...
                $('#chargeModal input[name="achievement_id"]').val(id);
            }
