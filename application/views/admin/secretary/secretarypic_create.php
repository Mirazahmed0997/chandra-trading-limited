        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10">
                            <h3 class="card-title">Add New সম্পাদকের ছবি</h3>
                        </div>
                    </div>
                    
                </div>
                <div class="card-body">
                    <?php echo form_open_multipart('Admin/secretarypic_store', 'role="form" id="fromvalid"'); ?>
                    <div class="row">
                            <div class="col-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Add সম্পাদকের ছবি</button>
