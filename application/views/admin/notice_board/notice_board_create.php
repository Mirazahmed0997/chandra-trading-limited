        ...
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open_multipart('Admin/notice_board_store', 'role="form" id="fromvalid"'); ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control input-sm" type="text"
                                            placeholder="Enter Title" data-bv-notempty="true">
                                    </div>
                                    <div class="form-group">
                                        <label id="publish_date">Publish Date*</label>
                                        <input type="date" name="publish_date" id="publish_date" class="form-control input-sm" data-bv-notempty="true">
                                    </div>
                                    <div class="form-group">
