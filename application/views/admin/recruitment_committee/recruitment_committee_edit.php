        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="card-title">নিয়োগ কমিটি পরিবর্তন</h3>
                        </div>
                    </div>
                </div>
                <form action="<?php echo base_url('') ?>Admin/recruitment_committee_update"
                        method="post">
                        <input type="hidden" name="rc_id" value="<?php if(!empty($recruitment_committee)) { echo $recruitment_committee->rc_id; } ?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" value="<?php if(!empty($recruitment_committee)) { echo $recruitment_committee->rc_title; } ?>" name="title"
                            ...
                            <div class="col-md-12">
                                ...
                                <span class="text-danger">*</span>
                                <textarea name="details" class="form-control" value="" required><?php if(!empty($recruitment_committee)) { echo $recruitment_committee->rc_details; } ?></textarea>
                            </div>
                                ...
                                <div class="">
                                    <table class="table table-striped table-bordered table-hover" id="edittableID">
                                        ...
                                        <?php if(!empty($rcd_list)) { 
                                            ...
                                            ?>
                                            <input type="hidden" name="rcd_id[]" id="rcd_id<?php echo $i; ?>" value="<?php echo $value->rcd_id; ?>">
                                        <tr id="row<?php echo $i ?>">
                                            <td>
                                                <input type="text" name="name[]"  id="name<?php echo $i ?>" class="form-control" value="<?php echo $value->rcd_name; ?>" required>

                                            </td>
                                            <td>
                                                <input type="text" name="designation[]"  id="designation<?php echo $i ?>" class="form-control" value="<?php echo $value->rcd_designation; ?>" required>

                                            </td>
                                            <td>
                                                <input type="number" name="mobile[]"  id="mobile<?php echo $i ?>" class="form-control" value="<?php echo $value->rcd_mobile; ?>" required>
