        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="card-title">ম্যানেজ সমিতির উদ্দেশ্য ও মূল কার্যক্রম</h3>
                        </div>
                        <div class="col-md-4 text-right">
                            <a href="<?php echo base_url(); ?>Admin/page1_create" class="btn bg-olive">Add সমিতির উদ্দেশ্য ও মূল কার্যক্রম</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="row">
                                            <div class="col-6">
                                                <form action="<?php echo base_url(); ?>Admin/page1_edit" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $value->id; ?>">
                                                    <button type="submit" class="custom_btn bg-info"><i class="fas fa-edit"></i></button>
                                                </form>
                                            </div>
                                            <div class="col-6">
                                                <form action="<?php echo base_url(); ?>Admin/page1_delete" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $value->id; ?>">
