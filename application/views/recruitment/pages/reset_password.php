    ...
    <div class="container job_details">
      <div class="row align-items-center">
        <div class="col-12 text-justify">
            <form action="<?php echo base_url('Login/code_check'); ?>" method="post">
                <input type="hidden" name="userType" value="2">
                <input type="hidden" name="login_value" value="1">
            <h1 class="text-center">Password Reset Code</h1>
            <hr>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-12">Password Reset Code <span style="color:red">*</span></div>
                        <div class="col-md-12"><input type="code" name="code" class="form-control" required placeholder="Enter your code..."></div>
