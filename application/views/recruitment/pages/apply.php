    ...
    <div class="container job_details">
      <div class="row align-items-center">
        <div class="col-12 text-justify">
            ...
            <form action="<?php echo base_url('Recruitment/apply_update') ?>" method="post" enctype='multipart/form-data'>
            <?php } else { ?>
            <form action="<?php echo base_url('Recruitment/apply_store') ?>" method="post" enctype='multipart/form-data'>
            <?php } ?>
            
            <div class="row">
                <div class="col-10">
                    <h1 class="text-center">রেজিস্ট্রেশন ও আবেদন ফরম</h1>
                </div>
                
            <?php if(empty($applicant_info)) { ?>
                <div class="col-2">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-sm">Import Your CV</button>
                </div>
                <?php } ?>
            </div>
            <hr>
            <h3><?php if(!empty($recruitment)) { echo $recruitment->rec_job_title; } ?></h3>
            <p>চাকরী ঠিকানাঃ <?php if(!empty($recruitment)) { echo $recruitment->rec_job_location; } ?></p>
            <p>চাকরী প্রকাশের তারিখঃ <?php if(!empty($recruitment)) { echo $recruitment->rec_publish_date; } ?></p>
            <p>আবেদনের শেষ তারিখঃ <?php if(!empty($recruitment)) { echo $recruitment->rec_last_date; } ?></p>
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="number" name="primary_mobile"id="NumberCode" class="form-control" required data-validation="length"
                    ...
                    <div class="row">
                        <div class="col-4">বাসার মোবাইল নম্বর</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8"><input type="email" name="email" class="form-control" required data-validation="length"
                ...
                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8"><input type="text" name="village" class="form-control" required data-validation="length"
                    ...
                    <div class="row">
                        ...
                        <div class="col-8"><input type="text" name="division" class="form-control" data-validation="length" data-validation-length="min2" value="<?php if(!empty($applicant_info)) { echo $applicant_info->r_division;} ?>" required></div>
                    </div>
                    <div class="row">
                ...
                <div class="col-md-12" style="clear:both;">
                    <div class="">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(!empty($applicant_info)) {
                                $where_data_ae['ae_r_candidate_id'] = $applicant_info->r_candidate_id;
                                $where_data_ae['ae_status'] = 1;
                                $education = $this->Common->get_data_multi_conditional('applicant_education',$where_data_ae)->result();
                                $i = 0;
                    ...
                    <div class="">
                        <table class="table table-striped table-bordered table-hover" id="tableID5">
                            ...
                            <tr id="row_ref<?php echo $i ?>">
                                ...
                                <td>
                                    <input type="email" name="ref_email[]"  id="email<?php echo $i ?>" class="form-control" value="<?php echo $value->ar_email; ?>">
                            ...
                            <?php $i++; } } else { ?>
                                <tr id="row_ref0">
                                    ...
                                    <td>
                                        <input type="email" name="ref_email[]"  id="email0" class="form-control">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input onchange="preview_image(event)" type="file" name="applicant_image" class="form-control-file" value=""  id="applicant_image">
                            ...
                            <?php if (!empty($applicant_info->r_image)){?>
                ...
                <div class="col-6">
                    ...
                    <?php if(empty($applicant_info)) { ?>
                    <div class="row">
                        <div class="col-4">পাসওয়ার্ড <span style="color:red">*</span></div>
                        <div class="col-8"><input type="password" name="password" id="password" class="form-control" required data-validation="length"
                                        data-validation-length="min2"></div>
                    </div>
                    <div class="row">
                        <div class="col-4">পুনরায় পাসওয়ার্ড <span style="color:red">*</span></div>
                        <div class="col-8">
                            <input type="password" name="password_confirm" id="password_confirm" class="form-control" required data-validation="length"
                                        data-validation-length="min2"  oninput="check(this)">
                            <span id="output"></span>
                        </div>
                    </div>
                    <?php } ?>
                ...
                <div class="col-12 text-center">
                    <?php if(!empty($applicant_info)) { ?>
                        ...
                        <?php $currentActiveId = $this->session->userdata('currentActiveId'); ?>
                        <input type="hidden" name="a_id" value="<?php if(!empty($currentActiveId)) { echo $currentActiveId; } ?>">
                    <?php } ?>
                    <br>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form action="<?php echo base_url('Login/authentication_process') ?>" method="post">
                ...
                <input type="hidden" name="login_value" value="2">
                <input type="hidden" name="rec_id" value="<?php if(!empty($recruitment)) { echo $recruitment->rec_id; } ?>">



				<div class="modal-header">
					<h4 class="modal-title">Applicant Login</h4>
