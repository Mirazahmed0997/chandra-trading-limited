    ...
    <div class="col-md-12 col-lg-12" style="">
        ...
        <div id="posts" class="small-thumbs alt">
            <div class="text-center">
                <h3 style="background-color:#25A454;color: white;margin:5px; padding:8px;">সভাপতিগণের তালিকা</h3>
            </div>
                    ...
                    <?php if(!empty($vice_principle)): ?>
                        <?php foreach($vice_principle as $k => $r):?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>Site/aboutpresident/<?php echo $r->id; ?>"><?php echo $r->title;?></a></td>
                                <td class="center">
