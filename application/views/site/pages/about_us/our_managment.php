...
<body>
  ...
  <section class="hero-3d-bg text-white py-5 position-relative">
    <div class="container py-5 text-center position-relative" style="z-index: 2;">
      ...
      <h1 class="display-3 fw-bold mt-2">Executive Management</h1>
      <p class="lead text-white-50 mx-auto fs-4" style="max-width: 750px;">
        Guided by decades of industry leadership, architectural innovation, and financial stewardship.
      </p>
    </div>
  </section>

  <!-- Key Executive Directors Grid -->
  <section class="py-5">
    <div class="container py-4">
      <div class="text-center mb-5">
        <span class="text-gold fw-bold text-uppercase tracking-wide">C-Suite Officers</span>
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="p-4 team-card h-100 d-flex flex-column" data-tilt data-tilt-max="12" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
            ...
            <div class="tilt-z2 flex-grow-1">
              <h3 class="fw-bold text-navy mb-1">Alexander Vance</h3>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="p-4 team-card h-100 d-flex flex-column" data-tilt data-tilt-max="12" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
            ...
            <div class="tilt-z2 flex-grow-1">
              <h3 class="fw-bold text-navy mb-1">Elena Rostova</h3>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="p-4 team-card h-100 d-flex flex-column" data-tilt data-tilt-max="12" data-tilt-speed="400" data-tilt-glare data-tilt-max-glare="0.2">
            ...
            <div class="tilt-z2 flex-grow-1">
              <h3 class="fw-bold text-navy mb-1">Marcus Sterling</h3>
  ...
  <!-- Advisory Board & Department Directors Section -->
  <section class="py-5 bg-light">
    <div class="container py-4">
      <div class="text-center mb-5">
        <span class="text-gold fw-bold text-uppercase tracking-wide">Domain Experts</span>
        <h2 class="display-6 fw-bold text-navy">Advisory Board & Department Heads</h2>
      </div>

      <div class="row g-4">
        <!-- Advisory Member 1 -->
        <div class="col-lg-6">
          <div class="p-4 board-card-3d d-flex align-items-center" data-tilt data-tilt-max="8" data-tilt-speed="300">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_hwcxn1PQBSma3J0mLF_CplAyFOryRQLGBQFXvvNl90wF99Rn0ikyq532&s=10" class="avatar-3d me-4 tilt-z2" alt="Board Member">
            <div class="tilt-z1">
              <h5 class="fw-bold text-navy mb-1">Dr. Aris Thorne</h5>
              <p class="text-gold small fw-bold mb-2">Head of Sustainable Architecture</p>
              <p class="text-muted small mb-0">PhD in Structural Engineering from MIT. Leads zero-emission building envelope integration.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="p-4 board-card-3d d-flex align-items-center" data-tilt data-tilt-max="8" data-tilt-speed="300">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_hwcxn1PQBSma3J0mLF_CplAyFOryRQLGBQFXvvNl90wF99Rn0ikyq532&s=10" class="avatar-3d me-4 tilt-z2" alt="Board Member">
            <div class="tilt-z1">
              <h5 class="fw-bold text-navy mb-1">David Chen</h5>
              <p class="text-gold small fw-bold mb-2">VP of Legal & Acquisitions</p>
              <p class="text-muted small mb-0">Specializes in commercial land rights, urban zoning compliance, and joint-venture contracts.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="p-4 board-card-3d d-flex align-items-center" data-tilt data-tilt-max="8" data-tilt-speed="300">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_hwcxn1PQBSma3J0mLF_CplAyFOryRQLGBQFXvvNl90wF99Rn0ikyq532&s=10" class="avatar-3d me-4 tilt-z2" alt="Board Member">
            <div class="tilt-z1">
              <h5 class="fw-bold text-navy mb-1">Samantha Hayes</h5>
              <p class="text-gold small fw-bold mb-2">Director of Client Relations</p>
              <p class="text-muted small mb-0">Manages high-net-worth investor portfolios and luxury residential advisory services worldwide.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="p-4 board-card-3d d-flex align-items-center" data-tilt data-tilt-max="8" data-tilt-speed="300">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_hwcxn1PQBSma3J0mLF_CplAyFOryRQLGBQFXvvNl90wF99Rn0ikyq532&s=10" class="avatar-3d me-4 tilt-z2" alt="Board Member">
            <div class="tilt-z1">
              <h5 class="fw-bold text-navy mb-1">Jonathan Wu</h5>
              <p class="text-gold small fw-bold mb-2">Chief Technology Officer</p>
              <p class="text-muted small mb-0">Oversees BIM (Building Information Modeling) and IoT smart building infrastructure systems.</p>
            </div>
          </div>
        </div>
      </div>
