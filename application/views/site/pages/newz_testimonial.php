                ...
                <div class="col-lg-5">
                    <div class="testimonial-card p-4 h-100 d-flex flex-column justify-content-between">
                        ...
                        <div class="mt-4 text-end">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRLn1KRroqT0RtYADtsKG6EBHBcqvEmILbUFFqm1SvJqdE4iuFKh35DUs&s=10" class="rounded-circle border border-2 border-warning" width="80" height="80" alt="Client">
                        </div>
                    </div>
                </div>
            </div>
