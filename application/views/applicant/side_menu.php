            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?= active_open('members_list', $main_nav); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url('permisssions') ?>" class="nav-link <?= active_nav('Applicant/members_list/members_list', $sub_nav); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Permission</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url('daily_installment_list') ?>" class="nav-link <?= active_nav('Applicant/members_list/members_list', $sub_nav); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Daily installment list</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('due_list') ?>" class="nav-link <?= active_nav('Applicant/members_list/members_list', $sub_nav); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>বকেয়া ও খেলাপি তালিকা</p>
                            </a>
                        </li>
